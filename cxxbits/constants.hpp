...
extern const torch::TensorOptions GPU_HALF;

extern const int64_t BOARD_WIDTH;
extern const int64_t BOARD_HEIGHT;
extern const int64_t ROTATIONS;
extern const int64_t ORIENTATIONS;
extern const int64_t COLORS;
extern const int64_t SHAPES;
